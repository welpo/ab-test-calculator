...
const regressionTestCases = [
  ...
  {
    name: "Three variants (one-sided; Šidák)",
    baseline: 0.05,
    relativeEffectSize: 0.1,
    alpha: 0.05,
    power: 0.8,
  ...
  {
    name: "Many variants (one-sided; Šidák)",
    baseline: 0.1,
    relativeEffectSize: 0.15,
    alpha: 0.05,
    power: 0.8,
  ...
  {
    name: "Many variants, low alpha (Šidák)",
    baseline: 0.01,
    relativeEffectSize: 0.1,
    alpha: 0.001,
    power: 0.99,
  ...
  {
    name: "Low CR, many variants (Šidák)",
    baseline: 0.001,
    relativeEffectSize: 0.05,
    alpha: 0.05,
    power: 0.8,
