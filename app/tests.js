...
const regressionTestCases = [
  ...
  {
    name: "Three variants (superiority; Šidák)",
    baseline: 0.05,
    relativeEffectSize: 0.1,
    alpha: 0.05,
    power: 0.8,
  ...
  {
    name: "Ultra high confidence (superiority)",
    baseline: 0.05,
    relativeEffectSize: 0.1,
    alpha: 0.001,
    power: 0.8,
  ...
  {
    name: "Many variants (superiority; Šidák)",
    baseline: 0.1,
    relativeEffectSize: 0.15,
    alpha: 0.05,
    power: 0.8,
